    ...
    def discover_toy(self):
        while (self.CLIENT.MODE == "ESTABLISH TOY"):
            ...
            if (received_message == "BEGIN TOY CONNECTION"):
                ...
                self.CLIENT.send_message.put("CLIENT 1: DECIDE ROLE")
              
            elif (received_message == "CHASER") or (received_message == "ESCAPER"):
                self.toy_role = received_message
                self.CLIENT.send_message.put("CLIENT 1: PLAYER ROLE DECIDED")
                print("STATUS: PLAYER ROLE DECIDED AS:", received_message)
            
            elif (received_message == "86B7") or (received_message == "0EF1") or (received_message == "E30c") or (received_message == "7740") or (received_message == "62C3") or (received_message == "27A5") or (received_message == "2C26") or (received_message == "AD13") or (received_message == "AE3F"):
                ...
                try:
                    ...
                    self.CLIENT.send_message.put("CLIENT 1: TOY CONNECTED")
        ...
        with self.connect_toy() as api:
            ...
            while exit_condition is False:
                ...
                if(self.CLIENT.MODE == "TOY DISCONNECT"):
                    ...
                    self.CLIENT.send_message.put("CLIENT 1: WAITING TO START")
                    ...
                    if(received_message == "GAME OVER"):
                        ...
                        self.CLIENT.send_message.put("CLIENT 1: WAITING TO RESTART")
                else:
                    time.sleep(1)
                    continue
                ...
                if (self.battery_voltage < self.voltage_threshold):
                    self.CLIENT.send_message.put("CLIENT 1: BATTERY LOW")
                    exit_condition = True
                    break
                ...
                if(lmList is not None and (len(lmList) > 30)):
                    ...
                    if self.server_forced_move:
                        ...
                        if(self.MODE == "CALIBRATION BEFORE START"):
                            ...
                            self.CLIENT.send_message.put("CLIENT 1: FIRST CALIBRATION OVER")
...
def main():
    ...
    if(CLIENT.MODE == "CLIENT CONNECTED"):
        ...
        while (True):
            ...
            del Sphero_obj
            CLIENT.send_message.put("CLIENT 1: TOY DISCONNECT")
            CLIENT.MODE = "ESTABLISH TOY"
