...
#pygame.display.set_caption('Poseball')
#bkgimg = pygame.image.load('bkg1.png')
#bkgimg = pygame.transform.scale(bkgimg,(screen_width,screen_height))
...
def scale_image(image_path):
    ...
    # Calculate the scale factor to fit the image within the constant screen dimensions
    scale_factor = min(screen_width / image_width, screen_height / image_height)

    # Scale the image to fit the screen
    scaled_image =  pygame.transform.scale(image, (int(image_width * scale_factor), int(image_height * scale_factor)))
...
# Create the Pygame window in fullscreen mode
screen = pygame.display.set_mode((screen_width, screen_height), pygame.FULLSCREEN)
pygame.display.set_caption("Pygame Full-Screen GUI with Background Image")

# Load the background image
#bkgimg1 = pygame.image.load("bkg1.png")  # Replace "background.jpg" with your image file

# Scale the background image to fit the screen resolution while maintaining the aspect ratio
#image_width, image_height = bkgimg1.get_size()
#scale_factor = min(screen_width / image_width, screen_height / image_height)
#bkgimg1t= pygame.transform.scale(bkgimg1, (int(image_width * scale_factor), int(image_height * scale_factor)))


#bkgimg2 = pygame.image.load('bkg2.png')
#image_width, image_height = bkgimg1.get_size()
#scale_factor = min(screen_width / image_width, screen_height / image_height)
#bkgimg2t= pygame.transform.scale(bkgimg2, (int(image_width * scale_factor), int(image_height * scale_factor)))

# Set the initial background image
current_background = scale_image('bkg1.png')
    ...
    def check_escape(self, object1, object2):
        if(object1 is not None) and (object2 is not None) :
            ...
            if (distance < (min(object1.w, object1.h)/2 +min(object2.w, object2.h)/2)):
                ...
                current_background = scale_image('bkg6.png')
    ...
    def check_collision(self, object1, object2):
        if(object1 is not None) and (object2 is not None):
            ...
            if (distance < self.collision_threshold*(object1.w+object1.h+object2.w+object2.h)/4):
                ...
                global current_background
                current_background = scale_image('bkg5.png')
                self.CLIENT1_MODE = "GAME OVER"
                self.CLIENT2_MODE = "GAME OVER"
                self.winner = "CHASER"
                return True
    ...
    def check_client1(self):
        ...
        if(self.CLIENT1_MODE == "CONNECT CLIENT"):
            if(received_message1 == "CLIENT 1: CONNECTED"):
                ...
                global current_background
                current_background = scale_image('bkg2.png')
                ...
                current_background = scale_image('bkg3.png')
            ...
            if(received_message1 == "CLIENT 1: DECIDE ROLE"):
                ...
                self.messenger.received_message.put(received_message1)
            elif(received_message1 == "86B7") or (received_message1 == "7740") or (received_message1 == "62C3") or (received_message1 == "27A5"):
    ...
    def check_client2(self):
        ...
        if(self.CLIENT2_MODE == "CONNECT CLIENT"):
            ...
            if(received_message2 == "CLIENT 2: DECIDE ROLE"):
                ...
                self.messenger.received_message.put(received_message2)
            elif(received_message2 == "86B7") or (received_message2 == "7740") or (received_message2 == "62C3") or (received_message2 == "27A5"):
        ...
        if(self.toy_disconnect_flag == True):
            ...
            if(received_message == "CLIENT 1: WAITING TO START") or (received_message == "CLIENT 2: WAITING TO START"):
                ...
                if(is_new == "Y") or (is_new == "y"):
                    ...
                    global current_background
                    current_background = scale_image('bkg4.png')
                else:
...
def main():
    ...
    while True:
        ...
        #if(REFEREE.MODE != "GAME STARTED") and (REFEREE.MODE != "GAME OVER"):
        #    continue
        ...
        if(REFEREE.MODE == "GAME STARTED"):
            ...
            REFEREE.check_timer()
            #current_background= pygame.surfarray.make_surface(VIDEOGRAPHER.frame)
